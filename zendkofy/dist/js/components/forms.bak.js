(function (factory) {
    if (typeof define === "function" && define.amd) {
        ...
        define('material/form', ["jquery", "jquery/ui/easing"], factory);
    } else {
    ...
    $(document).ready(function () {
        ...
        $(document).on('focus', input_selector, function () {
            $(this).siblings('label, .zdk-prefix').addClass(ZDK_STR.ACTIVE);
        });
        ...
        var hiddenDiv = $('.zdk-hiddendiv').first();
        if (!hiddenDiv.length) {
            hiddenDiv = $('<div class="zdk-hiddendiv common"></div>');
        ...
        $(document).on('change', '.file-field input[type="file"]', function () {
            var file_field = $(this).closest('.zdk-file-field');
        ...
        $.fn.autocomplete = function (options) {
            ...
            return this.each(function () {
                ...
                var data = options.data,
                    $inputDiv = $input.closest('.zdk-input-field'); // Div to append on

                // Check if data isn't empty
                if (!$.isEmptyObject(data)) {
                    // Create autocomplete element
                    var $autocomplete = $('<ul class="zdk-autocomplete-content zdk-dropdown-content"></ul>');
                    ...
                    var highlight = function (string, $el) {
                        ...
                        $el.html("<span>" + beforeMatch + "<span class='zdk-highlight'>" + matchText + "</span>" + afterMatch + "</span>");
                        if (img.length) {
                            $el.prepend(img);
                        }
                    };
    ...
    $.fn.material_select = function (callback) {
        ...
        function toggleEntryFromArray(entriesArray, entryIndex, select) {
            ...
            select.siblings('ul.dropdown-content').find('li').eq(entryIndex).toggleClass(ZDK_STR.ACTIVE);
