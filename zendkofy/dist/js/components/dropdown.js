    ...
    $.fn.dropdown = function (options) {
        ...
        this.each(function () {
            ...
            function placeDropdown(eventType) {
                ...
                // Set Dropdown state
                activates.addClass(classActive);
                origin.addClass(classActive);
            ...
            function hideDropdown() {
                ...
                activates.removeClass(classActive);
                origin.removeClass(classActive);
                setTimeout(function () {
            ...
            if (options.hover) {
                ...
                origin.bind('click.' + origin.attr('id'), function (e) {
                    if (!isFocused) {
                        ...
                        else if (origin.hasClass(classActive)) {
                            hideDropdown();
                            $(document).unbind('click.' + activates.attr('id') + ' touchstart.' + activates.attr('id'));
                        }
                        // If menu open, add click close handler to document
                        if (activates.hasClass(classActive)) {
