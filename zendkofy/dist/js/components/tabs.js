(function (factory) {
    if (typeof define === "function" && define.amd) {
        ...
        define('material/tabs', ["jquery", "velocity"], factory);
    } else {
    ...
    var methods = {
        init: function (options) {
            ...
            return this.each(function () {
                ...
                $this.width('100%');
                var $active, $content, $links = $this.find(linkSelector),
                ...
                if ($active.length === 0) {
                    $active = $(this).find(linkActiveSelector).first();
                }
                if ($active.length === 0) {
    ...
    $.fn.extend({
        meterialTabs: function (methodOrOptions) {
    ...
    $(document).ready(function () {
        $('ul[data-materialize-init=true].zdk-tabs').meterialTabs();
    });
}));
